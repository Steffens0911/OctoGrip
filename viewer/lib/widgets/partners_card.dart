...
/// Card "Parceiros" com ícone de aperto de mãos, descrição e botão "Ver parceiros".
class PartnersCard extends StatelessWidget {
  const PartnersCard({
    super.key,
    this.title = 'Parceiros',
    this.description = 'Conheça os parceiros da academia.',
    this.buttonLabel = 'Ver parceiros',
    this.onTap,
  });
