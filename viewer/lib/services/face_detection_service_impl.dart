...
class CameraController {
  ...
  /// True when the camera is streaming and has produced at least one frame.
  bool get hasActiveFrame => _video != null && _video!.videoWidth > 0;

  /// Registers the video element as a Flutter platform view so it can be
  /// embedded via [HtmlElementView]. Must be called after [start].
